...
class Epay_Invoice extends Model
{
    ...
    {
        $configurations = [
            'api_key' => env('CHARGILY_EPAY_KEY', 'laravel-chargily-epay.key'),
            'api_secret' => env('CHARGILY_EPAY_SECRET', 'laravel-chargily-epay.secret'),

            'urls' => [
                'back_url' => env('CHARGILY_EPAY_BACK_URL', 'laravel-chargily-epay.back_url'),
                'webhook_url' => env('CHARGILY_EPAY_WEBHOOK_URL', 'laravel-chargily-epay.webhook_url'),
            ],
        ] + $configurations;
